          ...
          .col-12.bg-c1(data-aos="zoom-in")
            .p-3
              .row.align-items-center
                .col.mb-4.mb-md-0
                  p.mb-0 Las habilidades de comunicación para con los padres y familiares son fundamentales durante la atención; escuchar a la madre, la hace sentir segura, con confianza en sí misma, respetando sus sentimientos, pensamientos, creencias y cultura, sin decirle lo que debería hacer ni presionarla a realizar alguna acción en particular. Estas habilidades son especialmente útiles ayudando a la madre a tener éxito en la lactancia.
                .col-md-auto
                  figure
      ...
      .col-lg-8(data-aos="zoom-in")
        AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--azul")
          .row(titulo="Habilidades comunicativas o lingüísticas")
            .col-12
              p Las principales habilidades comunicativas del recién nacido son:
          ...
          .row(titulo="Desarrollo y movimiento físico")
            .col-12
              ...
              p.mb-0 Los reflejos del recién nacido suelen desaparecer con el tiempo, la permanencia de alguno de estos, después de cierta edad, puede ser un indicador de signo de alarma de daños neurológicos o relacionados con el sistema nervioso.
          .row(titulo="Desarrollo social y emocional")
            .col-12
              p Relacionado con la generación de vínculos con impacto en la salud física del recién nacido como en condiciones socioemocionales evidentes de la madre, padre o cuidador, en los siguientes aspectos:
              ul.lista-ul--color.lista-ul.mb-0
                li.d-flex
                  i.fas.fa-chevron-right
                  | La voz o el tacto de sus padres o cuidadores mantiene la tranquilidad de la niña o niño, quien logra identificar de acuerdo a los tiempos compartidos.
                li.d-flex
                  i.fas.fa-chevron-right
                  | Identifica los sonidos no solo de seres humanos sino de otros ambientes que al momento de trasladarse pueden llevarlo a sentirse indefenso o que algo no está bien y expresarlo mediante el llanto.
                li.d-flex
                  i.fas.fa-chevron-right
                  | Los periodos de alerta del recién nacido que, al encontrarse en contacto con otros sonidos, voces o cambios en la temperatura de acuerdo a su entorno habitual, no descansa o no come, como mecanismo de comunicación indicando no encontrarse seguro. Lo que puede reforzar con llanto irritable manifestando necesidades de estar con sus padres o cuidadores que lo acompañan desde su nacimiento.
          .row(titulo="Habilidades cognitivas")
            .col-12
              p Permiten evaluar el proceso de aprendizaje y el desarrollo del pensamiento mediante elementos como formas, colores o sonidos los cuales apoyan su adaptación para reconocer el ambiente, plantas, animales, objetos y personas en distintas situaciones. Por ejemplo:
              ul.lista-ul--color.lista-ul.mb-0
                li.d-flex
                  i.fas.fa-chevron-right
                  | En espacios que le ofrecen tranquilidad y estar alerta, observa y sigue las formas y colores generando un aprendizaje adecuado a su desarrollo y edad.
                li.d-flex
                  i.fas.fa-chevron-right
                  | Identifica colores vivos mirándolos fijamente cuando son puestos frente a su cara.
                li.d-flex
                  i.fas.fa-chevron-right
      ...
      .col-12
        .p-5
          .row.justify-content-center
            .col-lg-10.bg-c4.p-4.p-lg-5.mb-5
              .row
                  ...
                  .row
                    .col-12.bg-c5.p-4
                      SlyderE(indicadores="derecha")
                        .row
                          .col-12
                            p #[b Reflejo de búsqueda]
                            p.mb-0 Gira la cabeza en busca del pecho o del elemento que lo alimentará y succiona cuando logra un estímulo que lo lleve a iniciar este proceso, Fundamental para desarrollar fuerza y coordinación, sostenerse y avanzar en crecimiento.
                        .row
                          .col-12
                            p #[b Reflejo de moro (respuesta de sobresalto)]
                            p.mb-0 Se presenta de manera involuntaria evidente cuando se asusta y abre sus extremidades superiores o inferiores recogiéndolas sobre su cuerpo, generado como instinto de defensa que puede estar acompañado de llanto.
                        .row
                          .col-12
                            p #[b Reflejo de presión]
                            p.mb-0 Para estimular este reflejo se pone un dedo en la palma del recién nacido para que este agarre, al intentar retirar el dedo hace que el agarre genere más presión permitiendo evaluar la fuerza y desarrollando destrezas en motricidad.
                        .row
                          .col-12
                            p #[b Reflejo tónico del cuello (posición de esgrima)]
                            p.mb-0 Estímulo muscular que se presenta de manera automática generando distintas sensaciones, la más marcada: gira la cabeza hacia un lado y estira el brazo de ese lado mientras flexiona el brazo opuesto.
                        .row
                          .col-12
      ...
      .col-12
        .px-5
          TabsC.color-acento-botones
            .py-3.py-md-4(titulo="Educación para la salud").bg-white
              .row.align-items-center.justify-content-center
                .col-lg-4.mb-4.mb-lg-0
                  figure
                    img(src='@/assets/curso/tema1/img6.png', style="width: 450px" ,alt='').m-auto
                .col-lg-6.p-5.p-lg-0
                  p Hallazgos, necesidades e inquietudes para el cuidado de la gestante que debe recibir educación junto a su red de apoyo e incluirse en el plan integral del cuidado.
                  ul.lista-ul--color.lista-ul.mb-0
                    li.d-flex
                      i.fas.fa-chevron-right
                      | Vínculos, redes y relaciones de cuidado, apoyo y acompañamiento a gestantes y sus familias. Implica el reconocimiento de vínculos de cuidado inmediato (familia, vecinos, comunidad, barrio, vereda).
                    li.d-flex
                      i.fas.fa-chevron-right
                      | Capacidades de la familia para el cuidado de la gestante y del recién nacido (necesidades de la mujer, signos de peligro, comunicación, apoyo y paternidad responsable).
            .py-3.py-md-4(titulo="Atención básica de orientación familiar").bg-white
              .row.align-items-center.justify-content-center
                .col-lg-4.mb-4.mb-lg-0
                  figure
                    img(src='@/assets/curso/tema1/img7.png', style="width: 450px" ,alt='').m-auto
                .col-lg-6.p-5.p-lg-0
                  p Identificación de capacidades y condiciones de funcionalidad de las familias, factores protectores y factores de riesgo que afecten el estado de salud de la madre.
          ...
          .row.justify-content-center
            ...
            .col-md-8.col-lg-4.bg-c11.m-2(data-aos="flip-right")
              .p-4
                figure.mb-4
                  img(src='@/assets/curso/tema1/img18.svg', style="width: 100px" ,alt='').m-auto
                p.text-center.mb-4 #[b Cuidar sus emociones]
                p.text-center.mb-0 Cada persona o momento puede ser una oportunidad para esa mamá, papá o cuidador inexperto que busca orientaciones claras sin ser juzgados y tener la posibilidad de expresar y argumentar sus ideas. Recuerde que el tono y el lenguaje no verbal son clave en todo proceso de comunicación.
